                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <c:forEach items="${groups}" var="group">
                                        <li><a href="/group/${group.id}">${group.name}
                                            <form method="Post" action="/group/delete/${group.id}" style="display:inline;">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Change Group <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <c:forEach items="${groups}" var="group">
                                        <li><button type="button" data-groupid="${group.id}" class="btn btn-link change-group">${group.name}</button></li>
                                    </c:forEach>
                                </ul>
                            </li>
                        </ul>
        ...
        <script>
            ...
            $('.change-group').click(function() {
                ...
                $("input[name='toDelete[]']:checked").each(function() {
                    data['toChangeGroup[]'].push($(this).val());
                });

                $.post("/contact/change-group", data, function(responseData, status) {
                    window.location.reload();
                });
            });
